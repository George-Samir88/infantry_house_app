...
import 'package:infantry_house_app/features/widgets/general_template/rating_horizontal_list_view.dart';
...
import 'item_feedback_view.dart';
                  ...
                  Column(
                    ...
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                GlobalData().isArabic
                                    ? widget.menuItemModel.titleAr
                                    : widget.menuItemModel.titleEn,
                                style: TextStyle(
                                  fontSize: 22.sp,
                            ...
                            Padding(
                              ...
                              child: Text(
                                GlobalData().isArabic
                                    ? widget.menuItemModel.descriptionAr
                                    : widget.menuItemModel.descriptionEn,
                                style: TextStyle(
                                  fontSize: 16.sp,
                                  color: Colors.brown[600],
                                  height: 1.4,
                                ...
                                child: ElevatedButton.icon(
                                  ...
                                  onPressed: () {
                                    ...
                                    showSnackBar(
                                      context: context,
                                      message:
                                          "${S.of(context).AddedSuccessfully} ${GlobalData().isArabic ? widget.menuItemModel.titleAr : widget.menuItemModel.titleEn} ${S.of(context).ToCard}",
                                    );
                                  },
                                ),
                              ),
                      ...
                      if (cubit.ratingsList.isNotEmpty) ...[
                        ...
                        state is RatingGetRatingFailure
                            ? CustomErrorTemplate(
                              onRetry: () {
                                cubit.getRatings(
