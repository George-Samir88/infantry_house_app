...
import 'package:infantry_house_app/views/widgets/editing_carousel_view/manager/edit_carousel_food_and_beverage_cubit.dart';
...
import 'empty_carousel_item.dart';

class EditCarouselView extends StatefulWidget {
  const EditCarouselView({super.key});

  @override
  State<EditCarouselView> createState() => _EditCarouselViewState();
}

class _EditCarouselViewState extends State<EditCarouselView>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: BlocBuilder<EditCarouselOfFoodAndBeverageCubit, EditCarouselOfFoodAndBeverageState>(
