...
class UpdateExistingItemView extends StatefulWidget {
  const UpdateExistingItemView({
    super.key,
  ...
  @override
  State<UpdateExistingItemView> createState() => _UpdateExistingItemViewState();
}

class _UpdateExistingItemViewState extends State<UpdateExistingItemView>
