...
import '../../food_and_beverage_view/manager/custom_menu_and_button_menu/food_and_beverage_button_and_menu_cubit.dart';

class EditingMenuButtonsView extends StatefulWidget {
  const EditingMenuButtonsView({super.key});


  @override
  State<EditingMenuButtonsView> createState() => _EditingMenuButtonsViewState();
}

class _EditingMenuButtonsViewState extends State<EditingMenuButtonsView>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<FoodAndBeverageButtonAndMenuCubit, FoodAndBeverageButtonAndMenuState>(
        builder: (context, state) {
          var cubit = context.read<FoodAndBeverageButtonAndMenuCubit>();
          List<String> newButtonTitlesList = [];
          newButtonTitlesList =
              cubit
