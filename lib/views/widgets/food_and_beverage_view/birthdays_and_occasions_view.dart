...
class BirthdaysAndOccasionsView extends StatefulWidget {
  const BirthdaysAndOccasionsView({super.key});

  @override
  State<BirthdaysAndOccasionsView> createState() =>
      _BirthdaysAndOccasionsViewState();
}

class _BirthdaysAndOccasionsViewState extends State<BirthdaysAndOccasionsView> {
  int currentIndex = 0;

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<EditCarouselOfFoodAndBeverageCubit, EditCarouselOfFoodAndBeverageState>(
                  ...
                  child: CustomEditButton(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => EditCarouselView(),
                        ),
                      );
                    },
                    icon: Icons.edit,
                  ...
                  CustomEditButton(
                    ...
                    onTap: () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) => EditingMenuButtonsView(
