...
class EditCarouselViewTemplate extends StatefulWidget {
  const EditCarouselViewTemplate({super.key});

  @override
  State<EditCarouselViewTemplate> createState() =>
      _EditCarouselViewTemplateState();
}

class _EditCarouselViewTemplateState extends State<EditCarouselViewTemplate>
