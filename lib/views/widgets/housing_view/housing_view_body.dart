...
class HousingViewBody extends StatefulWidget {
  const HousingViewBody({super.key});

  @override
  State<HousingViewBody> createState() => _HousingViewBodyState();
}

class _HousingViewBodyState extends State<HousingViewBody> {
  int currentIndex = 0;
            ...
            children: [
              ...
              CustomEditButton(
                onTap: () {
                  ...
                  //   context,
                  //   MaterialPageRoute(
                  //     builder: (context) => EditingMenuButtonsView(tabletLayout: ,),
                  //   ),
                  // );
                  // ;
                },
