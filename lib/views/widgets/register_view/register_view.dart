                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Column(
                            children: [
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: GlobalData().isTabletLayout ? 16.sp : 28.sp,
                        ...
                        Text(
                          ...
                          style: TextStyle(fontSize: GlobalData().isTabletLayout ? 10.sp : 20.sp),
                        ),
                        SizedBox(height: 8.h),
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            errorStyle: TextStyle(fontSize: GlobalData().isTabletLayout ? 6.sp : 10.sp),
                            hintStyle: TextStyle(
