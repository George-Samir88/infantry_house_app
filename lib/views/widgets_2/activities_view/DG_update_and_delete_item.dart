...
class DailyGamesUpdateAndDeleteItemView extends StatefulWidget {
  ...
  @override
  State<DailyGamesUpdateAndDeleteItemView> createState() =>
      _DailyGamesUpdateAndDeleteItemViewState();
}

class _DailyGamesUpdateAndDeleteItemViewState
    extends State<DailyGamesUpdateAndDeleteItemView>
  ...
  @override
  void initState() {
    titleController.text = widget.dailyActivityItemModel.title;
    priceController.text = widget.dailyActivityItemModel.price;
    trainerNameController.text = widget.dailyActivityItemModel.trainerName;
    descriptionController.text = widget.dailyActivityItemModel.description;
    imagePath = widget.dailyActivityItemModel.activityImage;
                      ...
                      Expanded(
                        child: CustomElevatedButton(
                          onPressed: () {
                            ...
                            DailyActivityItemModel? tmpItem =
                                widget.dailyActivityItemModel;
