...
import 'package:infantry_house_app/views/widgets_2/food_and_beverage_view/FAD_edit_screen_department_view.dart';
...
class FoodAndBeverageCustomHorizontalListDepartment extends StatefulWidget {
  const FoodAndBeverageCustomHorizontalListDepartment({super.key});

  @override
  State<FoodAndBeverageCustomHorizontalListDepartment> createState() =>
      _FoodAndBeverageCustomHorizontalListDepartmentState();
}

class _FoodAndBeverageCustomHorizontalListDepartmentState
    extends State<FoodAndBeverageCustomHorizontalListDepartment> {
  @override
                    ...
                    MaterialPageRoute(
                      builder:
                          (context) => BlocProvider.value(
                            value: cubit,
                            child: FoodAndBeverageEditScreenDepartmentView(),
                          ),
                    ),
                  );
                },
