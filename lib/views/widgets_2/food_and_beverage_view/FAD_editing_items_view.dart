...
import 'package:infantry_house_app/views/widgets_2/food_and_beverage_view/FAD_update_existing_item.dart';
...
import 'FAD_add_new_item_view.dart';
import '../../reusable_screens/custom_item_in_grid_edit_view.dart';

class FoodAndBeverageEditingItemsView extends StatefulWidget {
  const FoodAndBeverageEditingItemsView({
    super.key,
  ...
  @override
  State<FoodAndBeverageEditingItemsView> createState() =>
      _FoodAndBeverageEditingItemsViewState();
}

class _FoodAndBeverageEditingItemsViewState
    extends State<FoodAndBeverageEditingItemsView>
                                ...
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder:
                                        (context) => BlocProvider.value(
                                          value: cubit,
                                          child: FoodAndBeverageAddNewItemView(
