...
class FoodAndBeverageEditingMenuButtonsViewTemplate extends StatefulWidget {
  const FoodAndBeverageEditingMenuButtonsViewTemplate({
    super.key,
  ...
  @override
  State<FoodAndBeverageEditingMenuButtonsViewTemplate> createState() =>
      _FoodAndBeverageEditingMenuButtonsViewTemplateState();
}

class _FoodAndBeverageEditingMenuButtonsViewTemplateState
    extends State<FoodAndBeverageEditingMenuButtonsViewTemplate>
