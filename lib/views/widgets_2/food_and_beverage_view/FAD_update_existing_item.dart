...
class FoodAndBeverageUpdateExistingItemView extends StatefulWidget {
  const FoodAndBeverageUpdateExistingItemView({
    super.key,
  ...
  @override
  State<FoodAndBeverageUpdateExistingItemView> createState() =>
      _FoodAndBeverageUpdateExistingItemViewState();
}

class _FoodAndBeverageUpdateExistingItemViewState
    extends State<FoodAndBeverageUpdateExistingItemView>
