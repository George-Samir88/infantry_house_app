...
class EditingItemsViewTemplate extends StatefulWidget {
  const EditingItemsViewTemplate({
    super.key,
    required this.listIndex,
    required this.buttonTitle,
    required this.listToBeShow,
  });

  final List<MenuItemModel> listToBeShow;

  final int listIndex;
  final String buttonTitle;

  @override
  State<EditingItemsViewTemplate> createState() =>
      _EditingItemsViewTemplateState();
}

class _EditingItemsViewTemplateState extends State<EditingItemsViewTemplate>
                      ...
                      child: Stack(
                        ...
                        children: [
                          CustomMenuItemInGridEditView(
                            menuItemModel: widget.listToBeShow[index],
                            ...
                            child: Row(
                              children: [
                                CustomEditButton(
                                  ...
                                  height:
                                      GlobalData().isTabletLayout ? 44.h : null,
                                  width:
                                      GlobalData().isTabletLayout ? 25.w : null,
                                  iconSize:
                                      GlobalData().isTabletLayout ? 30.r : null,
                                  icon: Icons.edit,
                ...
                SliverToBoxAdapter(
                  child: Row(
                    children: [
                      ...
                      SizedBox(width: 10.w),
                      if (widget.listToBeShow.isNotEmpty)
                        Expanded(
                          child: CustomElevatedButton(
                            onPressed: () {
                              _playAnimation();
