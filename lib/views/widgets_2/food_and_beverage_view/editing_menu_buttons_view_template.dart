...
class EditingMenuButtonsViewTemplate extends StatefulWidget {
  const EditingMenuButtonsViewTemplate({super.key});


  @override
  State<EditingMenuButtonsViewTemplate> createState() =>
      _EditingMenuButtonsViewTemplateState();
}

class _EditingMenuButtonsViewTemplateState
    extends State<EditingMenuButtonsViewTemplate>
                                ...
                                Container(
                                  margin:
                                      index == newButtonTitlesList.length - 1
                                          ? EdgeInsets.only(
                                            right:
                                                GlobalData().isArabic ? 0 : 16,
                                            left:
                                                GlobalData().isArabic ? 16 : 0,
                                          )
                                          : null,
