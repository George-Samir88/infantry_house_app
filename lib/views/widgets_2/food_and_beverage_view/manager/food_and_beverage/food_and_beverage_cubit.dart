...
class FoodAndBeverageCubit extends Cubit<FoodAndBeverageState> {
  ...
  ///-----------------------Track Selected carousel item instead of setState-----------------------
  int currentCarouselIndex = 0;

  void changeCarouselIndex({required int index}) {
    currentCarouselIndex = index;
    emit(FoodAndBeverageChangeCarouselState());
  }
  ...
  ///initialize map between screens and its data---------------------------------
  void initializeMapBetweenScreensAndData() {
    ...
    emit(FoodAndBeverageInitializationBetweenScreensAndDataState());
  }
  ...
  void addNewScreen({required String screenTitle}) {
    ...
    emit(FoodAndBeverageAddNewCategoryState());
  }
  ...
  void removeScreen({required String screenTitle}) {
    ...
    emit(FoodAndBeverageRemoveCategoryState());
  }
  ...
  void resetScreenSelection() {
    ...
    emit(FoodAndBeverageResetCategorySelectionState());
  }
  ...
  void initializeMapBetweenButtonsAndItems() {
    ...
    emit(FoodAndBeverageInitializationBetweenButtonsAndItemsState());
  }
  ...
  void addNewButton({required String screenName, required String buttonTitle}) {
    ...
    emit(FoodAndBeverageAddNewButtonState());
  }
  ...
  void resetButtonSelection({required String screenName}) {
    ...
    emit(FoodAndBeverageResetMenuSelection());
  }
  ...
  void updateSelectedList({
    ...
    emit(FoodAndBeverageUpdateSelectedListState());
  }
  ...
  void addItem({
    ...
    emit(FoodAndBeverageAddNewItemState());
  }
  ...
  void removeItem({
    ...
    emit(FoodAndBeverageRemoveItemState());
  }
  ...
  void updateItem({
    ...
    if (true) {
      ...
      emit(FoodAndBeverageUpdateItemState());
    }
  }
