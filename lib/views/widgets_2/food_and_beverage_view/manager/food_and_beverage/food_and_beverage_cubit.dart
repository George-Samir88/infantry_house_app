...
class FoodAndBeverageCubit extends Cubit<FoodAndBeverageState> {
  ...
  void initializeMappingBetweenScreensAndButtonsTitle() {
    mapBetweenScreenTitlesAndButtonsTitle = {
      "باراديس": newAllButtonsAndItemsParadiseMap,
      "كافيهات": newAllButtonsAndItemsCafesMap,
    };
    newMapBetweenScreenTitlesAndButtonsTitle =
        mapBetweenScreenTitlesAndButtonsTitle;
    listToBeShow =
        newMapBetweenScreenTitlesAndButtonsTitle["كافيهات"]!["مانجو"]!;

    emit(CustomMenuInitializeMappingBetweenScreensAndButtonsTitleState());
  }
