...
class HousingAddNewItemView extends StatefulWidget {
  const HousingAddNewItemView({
    super.key,
  ...
  @override
  State<HousingAddNewItemView> createState() => _HousingAddNewItemViewState();
}

class _HousingAddNewItemViewState extends State<HousingAddNewItemView>
