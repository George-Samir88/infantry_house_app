...
import 'H_editing_items_view.dart';
import 'H_editing_menu_buttons_view_template.dart';

class HousingCustomButtonAndMenuTemplate extends StatelessWidget {
  const HousingCustomButtonAndMenuTemplate({
    super.key,
                        ...
                        MaterialPageRoute(
                          builder:
                              (context) => BlocProvider.value(
                                value: cubit,
                                child: HousingEditingMenuButtonsViewTemplate(
