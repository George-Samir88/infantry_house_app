...
import 'H_edit_screen_department_view.dart';

class HousingCustomHorizontalListDepartment extends StatefulWidget {
  const HousingCustomHorizontalListDepartment({super.key});

  @override
  State<HousingCustomHorizontalListDepartment> createState() =>
      _HousingCustomHorizontalListDepartmentState();
}

class _HousingCustomHorizontalListDepartmentState
    extends State<HousingCustomHorizontalListDepartment> {
  @override
  Widget build(BuildContext context) {
    return BlocBuilder<HousingCubit, HousingState>(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) => BlocProvider.value(
                                  value: cubit,
                                  child: HousingEditScreenDepartmentView(),
                                ),
                          ),
                        );
                      },
