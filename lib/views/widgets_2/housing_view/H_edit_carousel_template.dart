...
class HousingEditCarouselTemplateView extends StatefulWidget {
  const HousingEditCarouselTemplateView({super.key});

  @override
  State<HousingEditCarouselTemplateView> createState() =>
      _HousingEditCarouselTemplateViewState();
}

class _HousingEditCarouselTemplateViewState
    extends State<HousingEditCarouselTemplateView>
