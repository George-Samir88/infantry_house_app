...
class HousingEditScreenDepartmentView extends StatefulWidget {
  const HousingEditScreenDepartmentView({super.key});

  @override
  State<HousingEditScreenDepartmentView> createState() =>
      _HousingEditScreenDepartmentViewState();
}

class _HousingEditScreenDepartmentViewState
    extends State<HousingEditScreenDepartmentView>
