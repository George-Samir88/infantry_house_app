...
import 'H_custom_button_and_menu_template.dart';
import 'H_edit_carousel_template.dart';

class HousingCustomTemplate extends StatelessWidget {
  const HousingCustomTemplate({super.key});
      ...
      builder: (context, state) {
        ...
        return Column(
          ...
          children: [
            ...
            SizedBox(height: 20.h),
            HousingCustomButtonAndMenuTemplate(
              menuTitle:
