...
class HousingCubit extends Cubit<HousingState> {
  HousingCubit() : super(HousingInitial());
  ...
  void changeCarouselIndex({required int index}) {
    ...
    emit(HousingChangeCarouselState());
  }
  ...
  void initializeMapBetweenScreensAndData() {
    ...
    emit(HousingInitializationBetweenScreensAndDataState());
  }
  ...
  void addNewScreen({required String screenTitle}) {
    ...
    emit(HousingAddNewCategoryState());
  }
  ...
  void removeScreen({required String screenTitle}) {
    ...
    emit(HousingRemoveCategoryState());
  }
  ...
  void resetScreenSelection() {
    ...
    emit(HousingResetCategorySelectionState());
  }
  ...
  void initializeMapBetweenButtonsAndItems() {
    ...
    emit(HousingInitializationBetweenButtonsAndItemsState());
  }
  ...
  void resetButtonSelection({required String screenName}) {
    ...
    emit(HousingResetMenuSelection());
  }
  ...
  void updateSelectedList({
    ...
    emit(HousingUpdateSelectedListState());
  }
