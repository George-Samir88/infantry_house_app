...
class ReservationEditingMenuButtonsViewTemplate extends StatefulWidget {
  const ReservationEditingMenuButtonsViewTemplate({
    super.key,
  ...
  @override
  State<ReservationEditingMenuButtonsViewTemplate> createState() =>
      _ReservationEditingMenuButtonsViewTemplateState();
}

class _ReservationEditingMenuButtonsViewTemplateState
    extends State<ReservationEditingMenuButtonsViewTemplate>
