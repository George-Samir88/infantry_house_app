...
class ReservationCubit extends Cubit<ReservationState> {
  ...
  void changeCarouselIndex({required int index}) {
    ...
    emit(ReservationChangeCarouselState());
  }
  ...
  void initializeMapBetweenScreensAndData() {
    ...
    emit(ReservationInitializationBetweenScreensAndDataState());
  }
  ...
  void resetScreenSelection() {
    ...
    emit(ReservationResetCategorySelectionState());
  }
  ...
  void changeSelectedScreen({required String buttonCategoryTitle}) {
    ...
    emit(ReservationChangeScreenState());
  }
  ...
  void initializeMapBetweenButtonsAndItems() {
    ...
    emit(ReservationInitializationBetweenButtonsAndItemsState());
  }
  ...
  void addNewButton({required String screenName, required String buttonTitle}) {
    ...
    emit(ReservationAddNewButtonState());
  }
  ...
  void resetButtonSelection({required String screenName}) {
    ...
    emit(ReservationResetMenuSelection());
  }
  ...
  void updateSelectedList({
    ...
    emit(ReservationUpdateSelectedListState());
  }
  ...
  void addItem({
    ...
    emit(ReservationAddNewItemState());
  }
  ...
  void removeItem({
    ...
    emit(ReservationRemoveItemState());
  }
  ...
  void updateItem({
    ...
    if (true) {
      ...
      emit(ReservationUpdateItemState());
    }
  }
